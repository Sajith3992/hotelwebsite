...
<div class="container-fluid " id="main-content" >
    <div class="row">
        ...
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                    ...
                    <div class="modal-dialog">
                        <form id="general_s_form">
                            <div class="modal-content">
                                ...
                                <button type="button" onclick ="site_title.value = general_data.site_title , site_about.value = general_data.site_about" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Cansel</button>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <div class="form-check form-switch">
                                <form action="">
                                  <input onchange="upd_shutdawn(this.value)" class="form-check-input" type="checkbox" id ="shutdawn-toggle">
                                </form>
            ...
            <!-- Contact Modal -->
            <div class="modal fade" id="contact-s" data-bs-keyboard="true" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <form id="contact_s_form">
                            <div class="modal-content">
                                                   ...
                                                   <div class="mb-3">
                                                        <label  class="form-label fw-bold">Social Links</label>
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name ="tk" id="tk_inp" class="form-control shadow-none" >
                                                            </div>

                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text" ><i class="bi bi-linkedin"></i></span>
                                                                <input type="text" name ="li" id="li_inp" class="form-control shadow-none" >
                                                            </div>
                                ...
                                <div class="modal-footer">
                                <button type="button" onclick ="contacts_inp(contacts_data)" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Cansel</button>
                                <button type="submit" class="btn custom-bg text-white shadow-none">Save</button>
                                </div>
                            </div>
                        </form>
